						...
						<div class="card rounded pad-20">
							<div class="card-content collapse show">
								<div class="card-body card-dashboard">
									<div class="row">
										<div class="col-12">
											<h1><a href="users.php"><i class="fa fa-angle-left"></i>User Listing</a></h1>
											<div class="pro-info">
									...
									<div class="maain-tabble table-responsive">
										<table class="table">
											...
											<tr v-for="(order, index) in orders">
                                                ...
                                                <td v-if="order.status == 'In Proccess' " v-bind:style="{'color':'yellow'}">In Proccess</td>
...
export default {
    ...
    components:{Layout,DatePicker},
            ...
            methods:{
                ...
                this.orders = response.data.user_order_log.data    
